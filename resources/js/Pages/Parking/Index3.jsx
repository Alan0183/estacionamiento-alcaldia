...
export default function ParkingIndex() {
    ...
    return (
        <>
            ...
            <div style={{background:'#87384e',minHeight:'100vh',padding:24,
                    ...
                    <div style={{display:'flex',alignItems:'center',gap:14}}>
                        ...
                        <div className="floor-menu" style={{marginLeft:8}}>
                            <button className="floor-btn" onClick={()=>setMenuOpen(o=>!o)}>
                                ...
                                <span style={{fontSize:12,color:'#9e7a83',fontFamily:'monospace'}}>{pisoInfo?.sublabel}</span>
